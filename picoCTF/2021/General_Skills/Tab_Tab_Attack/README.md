# picoCTF 2021 [Tab, Tab, Attack](https://play.picoctf.org/practice/challenge/176)
...
1. When extracted, the ZIP archive contains many folders and [one binary](Addadshashanammu/Almurbalarammi/Ashalmimilkala/Assurnabitashpi/Maelkashishi/Onnissiralis/Ularradallaku/fang-of-haynekhtnamet)
```
...
```
2. This file contains the flag's string:
```
...
.comment
```
**Answer**: `picoCTF{l3v3l_up!_t4k3_4_r35t!_f3553887}`